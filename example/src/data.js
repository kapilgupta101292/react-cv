export const CVData = {
  personalData: {
    ...
    contacts: [
      {
        type: 'email',
        value: 'kapilguptansit@gmail.com',
      },
      {
        type: 'phone',
        value: '+919686262560',
      ...
      {
        type: 'linkedin',
        value: 'linkedin.com/in/kapilguptansit',
      },
      {
        type: 'github',
        value: 'github.com/kapilgupta101292',
      },
    ],
  },
  sections: [
    ...
    },
    {
      ...
      content: `6+ Years of extensive professional software development experience as Software Engineer in medium
to large sized projects in the area of Design, Development and Analysis.
\n 1) Strong Exprerience in developing applications using Spring, Spring Boot, Java, Nodejs and SQL.
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          datesBetween: 'Jun-2014 - Oct-2015',
